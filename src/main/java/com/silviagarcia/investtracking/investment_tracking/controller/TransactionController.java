...
public class TransactionController {
    ...
    public ResponseEntity<TransactionDTO> create(@RequestBody TransactionDTO dto,
                                                 ...
                                                 Authentication auth) {
        TransactionDTO created = transactionService.createTransaction(dto, itemId, auth.getName());
    ...
    public ResponseEntity<Void> delete(@PathVariable Long id, Authentication auth) {
        boolean deleted = transactionService.deleteTransaction(id, auth.getName());
        if (deleted) {
